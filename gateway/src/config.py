...
class Settings:
    ...
    def __init__(self):
        ...
        self.DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://bnbong:password@postgres:5432/bnbong")
        self.SERVICES_CONFIG_PATH = os.getenv("SERVICES_CONFIG_PATH", "/app/config/services.json")
